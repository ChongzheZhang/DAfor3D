...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    average_3d_result = 0.0
    for j, curcls in enumerate(current_classes):
        average_3d_result += ret_dict['%s_3d/easy_R40' % class_to_name[curcls]]
        average_3d_result += ret_dict['%s_3d/moderate_R40' % class_to_name[curcls]]
        average_3d_result += ret_dict['%s_3d/hard_R40' % class_to_name[curcls]]

    average_3d_result = average_3d_result / (len(current_classes)*3)
    result += print_str((f"average  3d  AP:{average_3d_result}"))
